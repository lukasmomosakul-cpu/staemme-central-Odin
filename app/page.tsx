...
export default function Home() {
  ...
  return <div className="shell">
    ...
    <div style={{ flex: 1, minWidth: 0 }}><div className="mobileNav"><strong>⚔ Stämme Central</strong><span aria-hidden="true">☰</span></div>
      <main className="main">
