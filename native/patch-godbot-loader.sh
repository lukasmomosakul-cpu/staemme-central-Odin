...
# Tampermonkey executes @require libraries before the userscript. Bundle the same
# libraries into the APK so GodBot does not depend on a browser extension runtime.
python3 - "$ASSET" <<'PY'
