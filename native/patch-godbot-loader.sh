...
new=r''' private void loadEnabledScripts(WebView v){
  ...
  try{
   ...
   String status="(function(){try{var e=document.getElementById('__odin_loader_status');if(!e){e=document.createElement('div');e.id='__odin_loader_status';e.style.cssText='position:fixed;bottom:8px;left:8px;z-index:2147483647;background:#111;color:#fff;padding:5px 9px;border:1px solid #777;border-radius:4px;font:12px sans-serif;opacity:.9';(document.body||document.documentElement).appendChild(e)}e.textContent='ODIN 1.1.39 · Loader aktiv'}catch(x){}})()";
   ...
   String js="(function(){try{if(window.__odinGodBotLoaded)return;window.__odinGodBotLoaded=true;new Function("+q+")();console.log('ODIN_GODBOT_EVAL_OK');var e=document.getElementById('__odin_loader_status');if(e)e.textContent='ODIN 1.1.39 · GodBot eval OK'}catch(e){window.__odinGodBotLoaded=false;console.error('ODIN_GODBOT_EVAL_ERROR',e&&e.stack?e.stack:e);var x=document.getElementById('__odin_loader_status');if(x){x.textContent='ODIN 1.1.39 · GodBot FEHLER';x.style.color='#f55'}}})()";
